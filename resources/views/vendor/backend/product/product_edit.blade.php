    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                <h5 class="card-title">Edit Product (ID: {{ $product->id }})</h5>
                <hr />
                                ...
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="product_tags" data-role="tagsinput"
                                            ...
                                            class="form-control visually-hidden" required>
                                        @error('product_tags')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="product_size" data-role="tagsinput"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="product_color" data-role="tagsinput"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <img src="{{ asset($product->product_thumbnail) }}" id="mainThmb"
                                                    width="80" height="80">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row" id="preview_img">
                                            @foreach ($uploadedImages as $image)
                                                <div class="col-md-3 mb-3" style="width: 100px;">
                                                    <img src="{{ asset($image->photo_name) }}" class="img-thumbnail"
                                                        alt="Image" width="100px" height="80px" style="border: 0;">
                                                    <input name="delete_image[]" type="checkbox" class="delete-checkbox"
                                                        data-image-id="{{ $image->id }}" value="{{ $image->id }}">
                                                    Delete
                                                </div>
                                            @endforeach
                                        </div>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="selling_price"
                                                ...
                                                class="form-control" id="inputPrice" placeholder="00.00" required>
                                            @error('selling_price')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="product_code"
                                                ...
                                                class="form-control" id="inputCostPerPrice" placeholder="00.00" required>
                                            @error('product_code')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="product_qty"
                                                ...
                                                class="form-control" id="inputStarPoints" placeholder="00.00" required>
                                            @error('product_qty')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row g-3">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label for="inputDescription" class="form-label">Product
                                                        Status</label>
                                                    <select name="status" class="form-select" id="inputDescription">
                                                        <option value="1"
                                                            {{ $product->status == 1 ? 'selected' : '' }}>Active</option>
                                                        <option value="0"
                                                            {{ $product->status == 0 ? 'selected' : '' }}>Inactive</option>
                                                    </select>
                                                    @error('status')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
