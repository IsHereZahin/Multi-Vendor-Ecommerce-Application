                            ...
                            <div class="card-body">
                                <form method="post" action="{{ route('admin.site.setting.update') }}"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <img id="showImage"
                                                src="{{ asset('frontend/assets/imgs/theme/' . $setting->logo) }}"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control"
                                                value="{{ $setting->updated_at->format('d M Y, h:i A') }}" disabled>
                                        </div>
                                    </div>
                                    ...
                                    @foreach (['facebook', 'twitter', 'instagram', 'youtube'] as $platform)
                                        <div class="row mb-4">
                                            <label class="col-sm-3 col-form-label">{{ ucfirst($platform) }} Url</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="{{ $platform }}_url" class="form-control"
                                                    value="{{ $setting[$platform . '_url'] }}">
                                            </div>
                                        </div>
                                    @endforeach
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="open_days" class="form-control"
                                                value="{{ $setting->open_days }}">
                                        </div>
                                    </div>

                                    <!-- copy right -->
                                    <div class="row mb-4">
                                        <label class="col-sm-3 col-form-label">Copy Right</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="maintenance_mode" class="form-control">
                                                <option value="0"
                                                    {{ $setting->maintenance_mode == 0 ? 'selected' : '' }}>Off</option>
                                                <option value="1"
                                                    {{ $setting->maintenance_mode == 1 ? 'selected' : '' }}>On</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <button type="submit" class="btn btn-primary"
                                                onclick="return confirm('Are you sure you want to save the changes?');">Save
                                                Settings</button>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <form method="get" action="{{ route('admin.site.setting.reset') }}">
                                    <button type="submit" class="btn btn-danger mt-3"
                                        onclick="return confirm('Are you sure you want to reset the changes?');">Reset to
                                        Default</button>
                                </form>
                            </div>
                        </div>
