                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <div class="sold mt-15 mb-15">
                                                @php
                                                    ...
                                                    $product_stock = max(1, round($product->product_qty * $randomMultiplier)); // Ensure $product_stock is at least 1
                                                    $soldPercentage = $product_stock > 0 ? ($product->product_qty / $product_stock) * 100 : 0; // Safe division
                                                @endphp
