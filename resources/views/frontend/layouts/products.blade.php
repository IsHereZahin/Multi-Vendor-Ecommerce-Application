                                                ...
                                                <div class="detail-info pr-30 pl-30">
                                                    ...
                                                    @if (!empty($product->product_size))
                                                        <div class="attr-detail attr-size mb-30">
                                                            <strong class="mr-10" style="width:50px;">Size :
                                                            </strong>
                                                    ...
                                                    @if (!empty($product->product_color))
                                                        <div class="attr-detail attr-color mb-30">
                                                            <strong class="mr-10" style="width:50px;">Color:
                                                            </strong>
                                                            <select class="form-control unicase-form-control"
                                                    ...
                                                    <div class="detail-info pr-30 pl-30">
                                                        <span class="stock-status out-stock">
                                                            ...
                                                            @if ($product->discount_price == null)
                                                                ...
                                                                @endif
                                                            @else
                                                                <span class="hot">Save {{ round($discount) }}
                                                                    %</span>
                                                            @endif
                                                        </span>
                                                        <h3 class="title-detail"><a
                    ...
                    <div class="tab-pane fade show active" id="tab-one-1" role="tabpanel"
                        ...
                        <div class="carausel-4-columns-cover arrow-center position-relative">
                            ...
                            <div class="carausel-4-columns carausel-arrow-center" id="carausel-4-columns">
                                @php
                                    $productsdata = App\Models\Product::where('status', 1)
                                        ->orderBy('id', 'ASC')
                                        ->latest()
                                        ->limit(10)
                                        ->get();
                                                                ...
                                                                @if ($discount > 0)
                                                                    <span>
                                                                        <span
                                                                            ...
                                                                            Off</span>
                                                                        <span
                                                                            class="old-price font-md ml-15">${{ $product->selling_price }}
                                                                        </span>
                                                                    </span>
                                                                @endif
                                                            </div>
