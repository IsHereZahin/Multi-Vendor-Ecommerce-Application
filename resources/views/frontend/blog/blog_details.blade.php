                            ...
                            <div class="col-lg-9">
                                <div class="single-page pt-50 pr-30">
                                    <div class="single-header style-2">
                                        <div class="row">
                                            <div class="col-xl-10 col-lg-12 m-auto">
                                                <h6 class="mb-10"><strong>Category:</strong> {{ $category->blog_category_name }}</h6><br>
                                    ...
                                    <div class="blog-image" style="text-align: center;">
                                        <img src="{{ asset($blog->blog_image) }}" alt="{{ $blog->blog_title }}" style="max-width: 100%; height: auto;">
                                    </div>  
                                     <div class="">                         
                                    <div class="row">
                                            <div class="col-xl-10 col-lg-12 m-auto">
