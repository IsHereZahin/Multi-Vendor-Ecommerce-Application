...
<div class="page-header breadcrumb-wrap">
    <div class="container">
        <div class="breadcrumb">
            ...
            <a href="{{ '/brands' }}" rel="nofollow"><span> All Brands</span></a>
...
<div class="container mb-30">
    <div class="archive-header-2 text-center pt-80 pb-50">
        <h1 class="display-2 mb-50">{{ $brand->name ?? 'Unknown' }}</h1>
    </div>
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12">
                                        <div class="detail-info pr-30 pl-30">
                                            <span class="stock-status out-stock">
                                                @php
                                                    $amount = $product->selling_price > 0 ? $product->selling_price - $product->discount_price : 0;
                                                    $discount = $product->selling_price > 0 ? 100 - (($amount / $product->selling_price) * 100) : 0;
                                                @endphp
        ...
        <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
            <div class="sidebar-widget widget-store-info mb-30 bg-3 border-0">
                <div class="brand-logo mb-30">
                    <img class="default-img" src="{{ url('upload/brands/'.$brand->image) }}" alt=""/>
                </div>
                <div class="brand-info">
                    <h4 class="mb-5"><a href="#" class="text-heading">{{ $brand->name ?? 'Unknown' }}</a></h4>
                </div>
            </div>
        </div>
    </div>
