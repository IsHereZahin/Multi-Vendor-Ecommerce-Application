                        ...
                        @if ($subcategory)
                            ...
                            <div class="breadcrumb">
                                ...
                                @if ($subcategory->category)
                                    <a
                                        href="{{ route('category.products', ['id' => $subcategory->category->id, 'slug' => $subcategory->category->slug]) }}">{{ $subcategory->category->name }}</a>
                                @endif
                ...
                <div class="sidebar-widget widget-category-2 mb-30">
                    ...
                    <ul>
                        @foreach ($subcategories as $subcategory)
                            <li>
                                <a
                                    href="{{ route('subcategory.products', ['id' => $subcategory->id, 'slug' => $subcategory->slug]) }}">
                                    @if ($subcategory->category->image)
                                        <img src="{{ asset('upload/categories/' . $subcategory->category->image) }}"
